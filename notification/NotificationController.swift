...
//    let strDate = formatter.string(from: Date())
    ...
    notificationValues.shared.NotificationInstance.append(receiveValue(title: notificatioTitle, Message: notificationMessage, IdentifireValue: identifier,date: Date()))
